...
public class Productos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/10 Productos.png"))); // NOI18N
    ...
    private void cargarTabla() {
        ...
        try {
            ...
            ps = con.prepareStatement("SELECT producto_nombre, producto_tipo, producto_precio FROM productos WHERE producto_activo=1");
            rs = ps.executeQuery();
            rsmd = rs.getMetaData();
